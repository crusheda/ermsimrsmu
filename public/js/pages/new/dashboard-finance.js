...
function floatchart() {
    ...
    }).render(), new ApexCharts(document.querySelector("#total-line-2-chart"), {
        chart: {
            type: "line",
            height: 60,
            sparkline: {
    ...
    }).render(), new ApexCharts(document.querySelector("#total-line-3-chart"), {
        chart: {
            type: "line",
            height: 60,
            sparkline: {
    ...
    new ApexCharts(document.querySelector("#cashflow-bar-chart"), e).render(), new ApexCharts(document.querySelector("#category-donut-chart"), {
        chart: {
            height: 300,
            type: "donut"
        },
