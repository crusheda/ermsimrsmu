...
// Route::group(['middleware' => ['auth']], function () {
    ...
    // BERKAS
        ...
        Route::get('laporan/bulanan/formverif', '\App\Http\Controllers\Berkas\LaporanBulananController@formVerif');
        Route::get('laporan/bulanan/formupload/{id}', '\App\Http\Controllers\Berkas\LaporanBulananController@formUpload');
        Route::get('laporan/bulanan/table/verif', '\App\Http\Controllers\Berkas\LaporanBulananController@tableVerif');
