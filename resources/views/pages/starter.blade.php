                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><span
                                                class="p-1 d-block bg-success rounded-circle"><span
                                                    class="visually-hidden">New alerts</span></span></div>
                                        <div class="flex-grow-1 mx-2">
                                            <p class="mb-0 d-grid text-start"><span class="text-truncate w-100">Figma
                                                    Auto Layout</span></p>
                                        </div>
                                    </div>
                                </a></div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4">
                                <div class="user-group able-user-group"><img src="{{ asset('images/user/avatar-1.jpg') }}"
                                        alt="user-image" class="avtar"> <img src="{{ asset('images/user/avatar-3.jpg') }}"
                                        alt="user-image" class="avtar"> <img src="{{ asset('images/user/avatar-4.jpg') }}"
                                        alt="user-image" class="avtar"> <img src="{{ asset('images/user/avatar-5.jpg') }}"
                                        alt="user-image" class="avtar"> <span
                                        class="avtar bg-light-primary text-primary text-sm">+2</span></div><a
                        ...
                        <div class="card-body border-bottom pb-0">
                            ...
                            <ul class="nav nav-tabs analytics-tab" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation"><button class="nav-link"
                                        ...
                                        aria-controls="analytics-tab-2-pane" aria-selected="false">Success</button></li>
                                <li class="nav-item" role="presentation"><button class="nav-link"
                                        id="analytics-tab-3" data-bs-toggle="tab"
                                        data-bs-target="#analytics-tab-3-pane" type="button" role="tab"
                                        aria-controls="analytics-tab-3-pane" aria-selected="false">Pending</button></li>
                            </ul>
                        </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-6">
                                    <div class="d-grid"><button class="btn btn-primary d-grid"><span
                                                class="text-truncate w-100">Create new Transaction</span></button></div>
                                </div>
                            </div>
                        </div>
                    </div>
