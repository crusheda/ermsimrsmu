...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-label-dark mb-3" href="{{ route('ipsrs.index') }}"><i class="bx bx-chevron-left me-1"></i>
                Kembali</a>
        </div>
        <div class="col-md-3">
                ...
                <div class="card-body">
                    <center>
                        @if (empty($list['show']->filename_pengaduan))
                            <img class="card-img-top img-thumbnail border mb-4" src="{{ url('img/no_image.jpg') }}"
                                style="height: 210px;width: auto" alt="Foto Pengaduan">
                            <button class="btn btn-primary" disabled>Download</button>
                        @else
                            <img class="card-img-top img-thumbnail border mb-4"
                                src="{{ url('storage/' . substr($list['show']->filename_pengaduan, 7, 1000)) }}"
                                style="height: 210px;width: auto" alt="Foto Pengaduan">
                            <button class="btn btn-primary"
                                onclick="window.location.href='{{ url('v2/laporan/pengaduan/ipsrs/' . $list['show']->id) }}'"><i
                                    class="bx bx-download"></i> Download</button>
                        @endif
                    </center>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-label-warning" id="btn-simpan-catatan"><i
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            @if (!empty($val->title))
                                                                <button class="btn btn-success btn-sm"
                                                                    onclick="window.location.href='{{ url('v2/laporan/pengaduan/ipsrs/catatan/' . $val->id) }}'"><i
        ...
        <div class="modal fade" id="ubahCatatan{{ $item->id }}" data-bs-backdrop="static" aria-hidden="true"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    {{ Form::model($list['show'], ['route' => ['pengaduan.ipsrs.ubahCatatan', $list['show']->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                    <div class="modal-body">
                        @csrf
