            ...
            <div class="card my-5">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-muted">Admin telah mengirimkan email untuk mengembalikan password akun Anda. Langkah recovery password terdapat pada email.</p>
                    </div>
                    <div class="d-grid mt-3"><button type="button" class="btn btn-primary">Sign in</button></div>
                    <div class="saprator mt-3"><span>Shortcut</span></div>
                    <div class="row g-2">
                        <div class="col-4">
                            <div class="d-grid"><button type="button"
                                    class="btn mt-2 btn-light-primary bg-light text-muted"><img
                                        ...
                                        class="d-none d-sm-inline-block">Google Mail</span></button></div>
                        </div>
                        <div class="col-4">
                            <div class="d-grid"><button type="button"
                                    class="btn mt-2 btn-light-primary bg-light text-muted"><img
