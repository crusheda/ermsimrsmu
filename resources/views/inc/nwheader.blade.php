            ...
            <ul class="list-unstyled"><!-- ======= Menu collapse Icon ===== -->
                ...
                <li class="pc-h-item d-none d-md-inline-flex">
                    <form class="form-search">
                        ...
                        <input type="search" class="form-control mt-3" placeholder="Ctrl + K">
                    </form>
                </li>
            </ul>
            ...
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item header-user-profile"><a
                        ...
                        role="button" aria-haspopup="false" data-bs-auto-close="outside" aria-expanded="false"><img
                            src="{{ asset('images/user/avatar-2.jpg') }}" alt="user-image" class="user-avtar"></a>
                                ...
                                <div class="d-flex mb-1">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1">Carson Darrin 🖖</h6><span><a
                                                ...
                                                data-cfemail="71121003021e1f5f15100303181f31121e1c01101f085f181e">[email&#160;protected]</a></span>
                                    </div>
                                </div>
